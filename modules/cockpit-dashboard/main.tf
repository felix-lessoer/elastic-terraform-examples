...
#   1. Export the dashboard from Kibana (Saved Objects → Export), or
#      POST /api/saved_objects/_export with objects=[{type:dashboard,id:<id>}]
#   2. Replace cockpit.ndjson with the export (excludeExportDetails=true)
#   3. terraform apply
