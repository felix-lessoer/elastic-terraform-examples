...
def build(gcp_path: Path) -> dict:
    ...
    # Drop GCP-only live metrics section panels (those with sectionId) and rebuild Azure ones.
    # Skip any prior OOTB nav panels — re-injected for Azure after assembly.
    ...
    panels_out = inject_ootb_nav(panels_out, "azure")
